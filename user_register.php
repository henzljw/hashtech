...
<html>
    <head>
        <title>Register | #hashtech Malaysia</title>
        ...
        <div class="register">
            <h1 style = "text-align: center; padding: 20px;">Register</h1>
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"])?>" method="POST">
                    <?php if(isset($message)) { echo $message; if($message != '') ?>
                    ...
                    <div class="input-group <?php echo (!empty($user_name_err)) ? 'has-error' : ''; ?>">
                        <input type="text" name="user_name" class="form-control" placeholder="Your Full Name" value="<?php if(isset($user_name)) { echo $user_name; } ?>" required>
                    ...
                    <div class="input-group <?php echo (!empty($user_email_address_err)) ? 'has-error' : ''; ?>">
                        <input type="email" name="user_email_address" class="form-control" placeholder="Email address" value="<?php if(isset($user_email_address)) { echo $user_email_address; } ?>"required>
                    ...
                    <div class="input-group <?php echo (!empty($phone_number_err)) ? 'has-error' : ''; ?>">
                        <input type="text" name="phone_number" class="form-control" placeholder="Mobile Phone number" value="<?php if(isset($phone_number)) { echo $phone_number; } ?>"required>
                    ...
                    <div class="input-group <?php echo (!empty($address_err)) ? 'has-error' : ''; ?>">
                        <input type="text" name="address" class="form-control" placeholder="Home / Office address" value="<?php if(isset($address)) { echo $address; } ?>"required>
                    ...
                    <div class="input-group <?php echo (!empty($city_err)) ? 'has-error' : ''; ?>">
                        <input type="text" name="city" class="form-control" placeholder="City" value="<?php if(isset($city)) { echo $city; } ?>"required>
                    ...
                    <div class="input-group <?php echo (!empty($user_password_err)) ? 'has-error' : ''; ?>">
                        <input type="password" name="user_password" class="form-control" placeholder="Password (Minimum of 6 characters with number and letter)" value="<?php if(isset($user_password)) { echo $user_password; } ?>" required>
                    ...
                    <div class="input-group <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>">
                        <input type="password" name="confirm_password" class="form-control" placeholder="Confirm Password" value="<?php if(isset($confirm_password)) { echo $confirm_password; } ?>" required>
